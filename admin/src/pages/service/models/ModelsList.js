    ...
    },
    {
      ...
      renderCell: (params) => (
        <div className="actionColumn">
          ...
          >
            <MenuItem>
              <Link to={`/service/models/detail/${currentId}`} className="text-decoration-none">
  ...
  return (
    <>
      <MainCard title="Models">
        <Row>
          <Col span={4} offset={20} style={styles.addButton} onClick={handleAddModel}>
            <Button type="primary" ><AppstoreAddOutlined /> Add Model</Button>
          </Col>
        </Row>
        <DataGrid
          rows={data}
